...
The docs tell you to disable developer mode after installation in Chrome, but you shouldn't do that because this will also disable the extension. Here is [the issue](https://github.com/LazyScar/BiliBili-To-English/issues/16) about that.
